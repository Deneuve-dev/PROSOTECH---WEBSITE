      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
        ...
        <div>
          ...
          <p className="text-gray-400 mt-8 leading-relaxed">
            ...
            integrated telecommunications, IT infrastructure, cybersecurity and
            renewable energy solutions. Our mission is to build reliable and
            scalable systems that power modern organizations and critical
            infrastructure.
          </p>

          <p className="text-gray-400 mt-6 leading-relaxed">
            Our engineering teams combine deep technical expertise with
            practical field experience to design and deploy systems that ensure
            performance, resilience and long-term operational reliability.
          </p>
